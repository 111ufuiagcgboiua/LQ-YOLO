...
def _get_reference_points(spatial_shapes, cuda, kernel_h, kernel_w, dilation_h, dilation_w, pad_h=0, pad_w=0,
...
def _generate_dilation_grids(spatial_shapes, kernel_h, kernel_w, dilation_h, dilation_w, group, cuda):
    _, H_, W_, _ = spatial_shapes
    points_list = []
    x, y = torch.meshgrid(
        torch.linspace(
...
def dcnv3_core_pytorch(
    ...
    spatial_norm = torch.tensor([W_in, H_in], requires_grad=False).reshape(1, 1, 1, 2). \
